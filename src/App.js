  ...
  render() {
    return (
      <section id="wrapper">
        ...
        <textarea id="editor" name="editor" onChange={this.handleTextChange} value={this.state.markdownText}>
